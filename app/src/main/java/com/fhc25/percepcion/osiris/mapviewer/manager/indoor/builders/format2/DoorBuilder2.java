...
public class DoorBuilder2 implements BuildingElementBuilder<Door> {
    ...
    public Door build(Feature feature) {
        ...
        if (feature.getProperties().containsKey("@type") &&
                ...
                (feature.getProperties().get("door").matches("hinged")||
                 feature.getProperties().get("door").matches("sliding"))) {
